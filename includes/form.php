...
?>
	...
	<div id="servicesContainer">	
		<fieldset id="srvcs">
			<legend id="services">What Services Are You Interested In?</legend>
			<input id="newSite" type="checkbox" name="Interested_In[]" value="New Website" tabindex="40" /> New Website <br />
			<input id="siteRedesign" type="checkbox" name="Interested_In[]" value="Website Redesign" /> Website Redesign <br />
			<input id="specialApp" type="checkbox" name="Interested_In[]" value="Logo Design" /> Logo Design <br />
			<input id="lollipop" type="checkbox" name="Interested_In[]" value="Branding" /> Branding <br />
			<input id="udderStuff" type="checkbox" name="Interested_In[]" value="Other" /> Other <br />
		</fieldset>
	</div>
...
<!--
		...
		<fieldset id="mailList">
			<legend id="mailingList">Would you like to join our mailing list?</legend>
			<input id="listYes" type="radio" name="Join_Mailing_List?" value="Yes" 
			required="required" title="Mailing list is required" tabindex="50"  
			/> Yes <br />
			<input id="listNo" type="radio" name="Join_Mailing_List?" value="No" /> No <br />
		</fieldset>
	</div>
-->
